...
import copy
from contact.dataset.contact_representation_dataset import ContactRepresentationDataset
...
class TrainVqvaeRepresentationWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        human_demonstrations_img = ContactRepresentationDataset(**cfg.dataset)
