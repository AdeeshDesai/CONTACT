from contact.envs.env_wrapper import IsaacEnvWrapper
from contact.utils.shear_tactile_viz_utils import visualize_tactile_shear_image, visualize_penetration_depth
...
def main(cfg: DictConfig):
    ...
    for _ in range(256):
        ...
        while not done:
            ...
            '''
            test_image = cv2.imread("./UR_robot_test.jpeg")
            #
