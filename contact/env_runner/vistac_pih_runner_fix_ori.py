...
from contact.gym_util.multistep_wrapper import MultiStepWrapper
from contact.gym_util.video_recording_wrapper import VideoRecordingWrapper
from contact.envs.vistac_isaacgym_multiple_env_wrapper import MultipleIsaacEnvWrapper
...
class ContactRunner(BaseImageRunner):
    def __init__(self,
            output_dir: str,
            shape_meta: dict,
