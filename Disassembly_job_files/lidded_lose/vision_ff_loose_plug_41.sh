...
NUM_DEMOS=50
NUM_EPOCH=500
DATASET_PATH=/scratch/gilbreth/desai274/CONTACT/data/lidded_loose_2
ISAACGYM_CONFIG="isaacgym_config_liddedloose.yaml"
ENV="WF"
VERSION=2
LOG_NAME="liddedloose_${SEED}_v${VERSION}"
...
CONTAINER_FILE=/scratch/gilbreth/desai274/CONTACT/apptainer/tvb.sif
