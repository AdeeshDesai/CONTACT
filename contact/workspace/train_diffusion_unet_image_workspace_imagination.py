...
from diffusion_policy.policy.diffusion_unet_image_tactile_policy import DiffusionUnetImagePolicy
    ...
    def run(self):
        ...
        with JsonLogger(log_path) as json_logger:
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if ((self.epoch % cfg.training.rollout_every) == 0) or (self.epoch > (cfg.training.num_epochs-10)):
